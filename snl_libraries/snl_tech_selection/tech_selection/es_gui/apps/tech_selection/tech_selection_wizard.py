...
from tech_selection.es_gui.resources.widgets.common import ValuationRunCompletePopup, RecycleViewRow, BASE_TRANSITION_DUR, ParameterRow2cols
from tech_selection.es_gui.apps.tech_selection.results_viewer import TechSelectionFeasible
from tech_selection.es_gui.apps.tech_selection.analysis import perform_tech_selection
from tech_selection.es_gui.apps.tech_selection.fAux import pdSeriesIdxWhereTrue
...
class TechSelectionUserInputs(Screen):
    ...
    def _next_screen(self, *args):
        ...
        destination_file = os.path.join(dirname, 'es_gui', 'apps', 'data_manager', '_static', 'tech_selection_params.json')
...
class TechSelectionConfirmInputs(Screen):
    ...
    def execute_run(self):
        ...
        dfRanking.to_csv(os.path.join(dirname, 'results', 'tech_selection', 'table_ranking.csv'))
