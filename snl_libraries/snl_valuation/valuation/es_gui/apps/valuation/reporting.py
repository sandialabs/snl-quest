...
from valuation.es_gui.proving_grounds.charts import BarChart, StackedBarChart, MultisetBarChart, PieChart, DonutChart
from valuation.es_gui.resources.widgets.common import TWO_ABC_WIDTH, THREE_ABC_WIDTH, MyPopup, ReportScreen, PALETTE, WizardReportInterface, ReportChartToggle
...
class GenerateReportMenu(ModalView):
    ...
    def save_figure(self, screen, *args):
        ...
        chart_images_dir = os.path.join(dirname, 'results', 'valuation', 'report', self.report_id, 'images')
    ...
    def generate_report_from_template(self):
        ...
        output_dir = os.path.join(dirname, 'results', 'valuation', 'report', output_dir_name)
