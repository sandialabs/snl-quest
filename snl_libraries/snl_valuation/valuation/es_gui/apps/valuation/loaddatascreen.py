...
from valuation.es_gui.tools.valuation.utilities import *
from valuation.es_gui.resources.widgets.common import MyPopup, InputError, RecycleViewRow
...
class LoadDataScreen(Screen):
    ...
    def reset_toolbar(self, **kwargs):
        ...
        if self.iso_select.text=='PJM':
            self.iso_img.source=os.path.join(dirname, 'es_gui', 'resources', 'images', 'IRCmap_pjm.png')
        elif self.iso_select.text=='MISO':
            self.iso_img.source=os.path.join(dirname, 'es_gui', 'resources', 'images', 'IRCmap_miso.png')
        elif self.iso_select.text=='ERCOT':
            self.iso_img.source=os.path.join(dirname, 'es_gui', 'resources', 'images', 'IRCmap_ercot.png')
        elif self.iso_select.text=='ISONE':
            self.iso_img.source=os.path.join(dirname, 'es_gui', 'resources', 'images', 'IRCmap_isone.png')
        elif self.iso_select.text=='NYISO':
            self.iso_img.source=os.path.join(dirname, 'es_gui', 'resources', 'images', 'IRCmap_nyiso.png')
        elif self.iso_select.text=='CAISO':
            self.iso_img.source=os.path.join(dirname, 'es_gui', 'resources', 'images', 'IRCmap_caiso.png')
        elif self.iso_select.text=='SPP':
            self.iso_img.source=os.path.join(dirname, 'es_gui', 'resources', 'images', 'IRCmap_spp.png')
