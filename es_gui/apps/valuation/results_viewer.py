...
from es_gui.resources.widgets.common import WarningPopup, MyPopup, PlotScreen


class ValuationPlotScreen(PlotScreen):
    ...
    def __init__(self, **kwargs):
        super(ValuationPlotScreen, self).__init__(**kwargs)
    ...
    def _update_toolbar(self, *args):
        ...
        super(ValuationPlotScreen, self)._update_toolbar(self)
