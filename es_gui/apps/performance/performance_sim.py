...
class PerformanceSimRunScreen(Screen):
    ...
    def _generate_requests(self):
        """Gets the requested data from each screen."""
    ...
    def run_batch(self):
        """Runs the performance simulation"""
    ...
    def check_eplus(self):
        """Ensures EnergyPlus is installed and in the QuESt directory"""
        try:
...
class PerformanceSimDataScreen(Screen):
    ...
    def _get_hvac_options(self):
        """Gets input files from data bank"""
    ...
    def _get_location_options(self):
        """Gets weather data from data bank"""
    ...
    def _get_profile_options(self):
        """Gets profile options from data bank and btm/valuation runs"""
    ...
    def _profile_selected(self):
        """Shows selectable charge/discharge profiles"""
    ...
    def _validate_inputs(self):
        """Ensures proper selections are made"""
...
class PerformanceSimSelectionsScreen(Screen):
    """Shows the performance simulation data and parameter selections"""
