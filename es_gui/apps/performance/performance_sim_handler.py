...
class PerformanceSimHandler:
    ...
    def process_requests(self, requests, *args):
        """Generates and solves EnergyPlus models based on the given requests."""
        dms = self.dms
        ...
        #Energyplus had crashed...restart QuESt
...
#    @staticmethod
    def _save_to_solved_ops(self,results,hvac,location,profile):
        """Saves the results of simulations"""
    ...
    def get_solved_sims(self):
        """Returns the list of solved  objects in reverse chronological order."""
