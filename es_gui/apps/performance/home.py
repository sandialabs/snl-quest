...
#        self.handler.dms = self.dms
    ...
    def open_help_carousel(self, *args):
        ...
        slide_08_text = "Battery parameters must be specified for the Lithium-ion or Lead-acid battery. They can be found or determined from nameplate values and the 1C discharge curve. The timestep parameter should not be changed unless you are knowledgable with EnergyPlus. The default values correspond to an LG 18650 lithium-ion cell."
