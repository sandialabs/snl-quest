...
class DataManagerLoadHomeScreen(Screen):
    ...
    def on_enter(self):
        ...
        ab.set_title('Data Manager: Hourly Commercial/Residential Load')


class DataManagerCommercialLoadScreen(Screen):
    """"""
    df_locations = ObjectProperty()
    ...
    def on_enter(self):
        ab = self.manager.nav_bar
        ab.build_data_manager_nav_bar()
        ab.set_title('Data Manager: Hourly Commercial Load')

        if not self.df_locations:
