...
#        print(self.progress)
    ...
    def set_callbacks(self):
        """
            Sets the callback functions of the state.
        """
...
#        self.runtime.callback_end_system_sizing(
#                state,self._end_system_sizing)
#        self.runtime.callback_after_component_get_input(
#                state,self._after_component_get_input)
#        self.runtime.callback_unitary_system_sizing(
#                state,self._unitary_system_sizing)
#        self.runtime.callback_register_external_hvac_manager(
#                state,self._register_external_hvac_manager)
        
        
            
    def append_eplus_data(self):
        """
            Collects Energyplus variable data at the end of each time step. Should 
            be called in "time step handler last". 
    ...
    def request_variables(self):
        """
            Requests variables in variablesF for access from Eplus.
        """
    ...
    def simulate(self):
        ...
        self.runtime.run_energyplus(self.state,[
                    '-d',
                    self.output_dir,
                    '-w',
                    self.weather,
    ...
    def new_simulation(self):
        """
            Runs a simulation with a new Eplus state.
        """
