...
VENV_PATH="$(cd "$(dirname "$0")" && pwd)/../../../app_envs/env_planning"
SETUP_PATH="$VENV_PATH/snl_quest_planning"
...
if [ ! -d "$SETUP_PATH/.git" ]; then
    git clone https://github.com/sandialabs/quest_planning.git "$SETUP_PATH"
fi
