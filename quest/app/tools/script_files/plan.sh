...
VENV_PATH="$(dirname "$0")/../../../app_envs/env_planning"
SETUP_PATH="$(dirname "$0")/../../../app_envs/env_planning/snl_quest_planning"

# Set the equity directory name
planning_dir="snl_quest_planning"
...
mkdir -p "$VENV_PATH/$planning_dir"
