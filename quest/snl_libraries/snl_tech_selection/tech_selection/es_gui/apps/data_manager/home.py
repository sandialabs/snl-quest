...
from tech_selection.es_gui.resources.widgets.common import NavigationButton
...
class DataManagerHomeScreen(Screen):
    ...
    def open_help_carousel(self, *args):
        ...
        slides = [
            (os.path.join(dirname, "es_gui", "resources", "help_views", "data_manager", "updated_home.png"), slide_01_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "data_manager", "02.png"), slide_02_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "data_manager", "03.png"), slide_03_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "data_manager", "04.png"), slide_04_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "data_manager", "05.png"), slide_05_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "data_manager", "weather.png"), slide_06_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "data_manager", "eplus_converter.png"), slide_07_text)
        ]
