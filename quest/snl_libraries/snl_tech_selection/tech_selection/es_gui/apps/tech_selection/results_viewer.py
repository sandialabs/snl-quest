...
from tech_selection.es_gui.resources.widgets.common import BASE_TRANSITION_DUR, WarningPopup, stnd_font
from tech_selection.es_gui.apps.tech_selection import fPlots
...
class TechSelectionRanking(Screen):
    ...
    def update_scores(self):
        ...
        self.dfRanking = pd.read_csv(os.path.join(dirname, 'results', 'tech_selection', 'table_ranking.csv'), index_col=0)
        ...
        fig.savefig(os.path.join(dirname, 'results', 'tech_selection', 'plot_ranking.png'))
...
class TechSelectionSaveResults(Screen):
    ...
    def feasibility_export_png(self):
        ...
        outname = os.path.join(dirname, 'results', 'tech_selection', f'{filename}.png')
    ...
    def ranking_export_csv(self):
        ...
        outname = os.path.join(dirname, 'results', 'tech_selection', f'{filename}.csv')
