...
import sys
mpl.use('module://tech_selection.libs.garden.garden_matplotlib.backend_kivy')
from tech_selection.libs.garden.garden_matplotlib.backend_kivyagg import FigureCanvasKivyAgg
...
class ResultsViewer(Screen):
    ...
    def open_help_carousel(self, *args):
        ...
        slides = [
            (os.path.join(dirname, "es_gui", "resources", "help_views", "common", "results_viewer", "01.png"), slide_01_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "common", "results_viewer", "02.png"), slide_02_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "common", "results_viewer", "03.png"), slide_03_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "common", "results_viewer", "04.png"), slide_04_text),
            (os.path.join(dirname, "es_gui", "resources", "help_views", "common", "results_viewer", "05.png"), slide_05_text),
        ]
