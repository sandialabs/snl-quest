...
class quest_workspace(QWidget):
    def __init__(self, parent=None):
       ...
       # d_icon = os.path.join(base_dir, "images", "icons", "data_icon.png")
        d_icon = os.path.join(base_dir, "images", "workspace", "post_add_24dp_376380_FILL0_wght200_GRAD0_opsz24.png")
        data_node_icon = QIcon(d_icon)
       # p_icon = os.path.join(base_dir, "images", "icons", "python_icon.png")
        p_icon = os.path.join(base_dir, "images", "workspace", "note_add_24dp_376380_FILL0_wght200_GRAD0_opsz24.png")
       ...
       # self.toolbar.addAction(action_data_node)
        ...
        # self.graph.set_background_color(25, 25, 25)
        # self.graph.set_grid_color(62, 62, 62)
        ...
        self.action_data_node.triggered.connect(self.create_data_node)
        self.action_py_node.triggered.connect(self.create_py_node)
