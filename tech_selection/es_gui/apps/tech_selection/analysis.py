...
import numpy as np
import pandas as pd
from tech_selection.es_gui.apps.tech_selection import fFeasibility, fPlots, fAux
...
def perform_tech_selection(selections, target_cost_kWh, target_cost_kW):
    ...
    fig.savefig(os.path.join(dirname, 'results', 'tech_selection', 'plot_feasibility.png'))
